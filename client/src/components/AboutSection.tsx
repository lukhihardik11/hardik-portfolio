  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ref={blob1Ref}
          className="absolute w-[400px] h-[400px] -top-20 right-0 jelly-float-blob-2 opacity-[0.04] dark:opacity-20"
          style={{
        ...
        <div
          ref={blob2Ref}
          className="absolute w-[350px] h-[350px] bottom-0 -left-20 jelly-float-blob-1 opacity-[0.03] dark:opacity-15"
          style={{
