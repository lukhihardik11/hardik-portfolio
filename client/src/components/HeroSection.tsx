  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ref={blob1Ref}
          className="absolute w-[320px] h-[320px] -top-24 -left-24 jelly-float-blob-1 opacity-[0.03] dark:opacity-25"
          style={{
        ...
        <div
          ref={blob2Ref}
          className="absolute w-[280px] h-[280px] -bottom-16 -right-16 jelly-float-blob-2 opacity-[0.02] dark:opacity-20"
          style={{
        ...
        />
        <div
          className="absolute w-[200px] h-[200px] top-1/3 left-1/3 jelly-float-blob-1 opacity-[0.02] dark:opacity-12"
          style={{
