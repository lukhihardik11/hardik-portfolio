...
const experiences = [
  {
    ...
    description: 'Promoted to lead hardware sustainment program for the EMG wristband — a next-generation neural interface wearable. Managing end-to-end project delivery across prototyping, test development, failure analysis, lab operations, and research coordination.',
    highlights: [
      'Promoted to lead hardware sustainment program, managing end-to-end project delivery across prototyping, test development, failure analysis, lab operations, and research coordination',
      'Lead cross-functional hardware sustainment team supporting EMG wristband development, collaborating with Manufacturing, Test, Quality, and Firmware engineering teams',
      ...
      'Designed and developed 15+ custom test fixtures and mechanical assemblies, increasing test throughput by 40%',
      'Automated factory test procedures using Python scripting, reducing test cycle times by 33% and eliminating manual bottlenecks',
      'Architected end-to-end MFG test solutions including test script development, PCB design, and driver integration',
      ...
      'Improved FPC designs through iterative testing, increasing product resilience and extending service life by 25%',
      'Applied SPC methodologies (Cpk, FAI) to validate manufacturing process capability and drive continuous improvement',
      'Implemented Agile Sprint methodology with weekly sprint planning, daily stand-ups, and retrospectives, improving team velocity tracking',
    ],
    prevHighlights: [
      'Executed reliability testing and failure analysis on hardware components per industry standards, supporting product quality gates',
      ...
      'Supported device build and prototyping activities including hands-on rework and repair of field returns',
      'Collaborated with software and firmware engineers to define test requirements and develop comprehensive test protocols',
    ],
    tech: ['Project Management', 'Agile/Scrum', 'JIRA', 'DOE', 'SPC', 'Failure Analysis', 'Test Fixtures', 'SolidWorks', 'Python', 'PCB Design'],
