/*
 * PHILOSOPHY — Refined spring physics + GSAP word-by-word reveal
 * Quote bounces in with spring animation. GSAP drives the word reveal.
 */
...
export function PhilosophySection() {
  ...
  // GSAP word-by-word reveal on the quote
  useEffect(() => {
  ...
  // Split quote text into word spans for GSAP
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] jelly-float-blob-1 opacity-[0.5] dark:opacity-100"
          style={{
